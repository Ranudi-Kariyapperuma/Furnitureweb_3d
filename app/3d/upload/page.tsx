      ...
      <main className="flex-1 flex flex-col items-center justify-center py-8">
        <div className="bg-gray-200 rounded-lg shadow-lg p-8 w-full max-w-4xl">
          <div className="flex justify-between items-center mb-6">
            <h1 className="text-2xl font-bold text-neutral-900">Upload Furniture</h1>
          ...
          <div className="flex justify-end mt-8">
            <Button className="bg-lime-700" onClick={handleUpload} disabled={!name || !model || !image || !description}>Upload</Button>
          </div>
        </div>
      </main>
    </div>
